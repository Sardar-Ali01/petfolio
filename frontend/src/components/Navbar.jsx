...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between items-center py-4 px-8 bg-[#f4effb] shadow-md relative z-50">
      {/* Logo Section */}
      ...
      <div className="flex space-x-4 items-center gap-[10px] relative">
